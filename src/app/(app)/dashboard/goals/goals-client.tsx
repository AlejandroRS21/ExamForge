// OpenSloth — Goals Client Component
  ...
  return (
    <div className="space-y-6">
      ...
      {activeGoal && (
        <div className="rounded-xl border p-6 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-semibold">Meta activa</h2>
            <button
      ...
      {parsedGoals.filter((g) => g.achieved).length > 0 && (
        <div className="rounded-xl border p-6 space-y-4">
          <h2 className="text-lg font-semibold">Metas logradas</h2>
      ...
      {!activeGoal && !showForm && (
        <div className="rounded-xl border border-dashed p-8 text-center space-y-4">
          ...
          <div>
            <h2 className="text-lg font-semibold">Sin meta activa</h2>
            <p className="text-sm text-muted-foreground mt-1">
              Establece un objetivo personal para hacer seguimiento de tu progreso
            </p>
          </div>
          <button
      ...
      {showForm && (
        <div className="rounded-xl border p-6 space-y-4">
          <h2 className="text-lg font-semibold">Establecer nueva meta</h2>
