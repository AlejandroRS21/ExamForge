// OpenSloth — Start Mock Exam Page
...
export default async function NewMockPage({ searchParams }: NewMockPageProps) {
    ...
    return (
      <div className="container mx-auto px-4 py-12 max-w-2xl">
        <div className="rounded-xl border bg-card p-8 space-y-6">
          <div>
            <h1 className="text-2xl font-bold">Iniciar simulacro: {part.label}</h1>
          ...
          <div className="grid grid-cols-2 gap-4 rounded-lg bg-muted/50 p-4">
            ...
            <div>
              <dt className="text-xs text-muted-foreground">Tiempo límite</dt>
          ...
          <div className="space-y-2 text-sm">
            ...
            <ul className="space-y-1 text-muted-foreground">
              <li>✓ El temporizador comienza en cuanto haces clic en «Empezar»</li>
              <li>✓ Las respuestas se envían automáticamente cuando se acaba el tiempo</li>
              <li>✓ No actualices ni cierres el navegador durante el examen</li>
              <li>✓ No puedes pausar ni reiniciar el examen una vez iniciado</li>
            </ul>
          </div>
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      <div className="rounded-xl border bg-card p-8 space-y-6">
        <div>
          <h1 className="text-2xl font-bold">Iniciar simulacro completo de R&UoE</h1>
        ...
        <div className="space-y-2 text-sm">
          <h3 className="font-semibold">Antes de empezar:</h3>
          <ul className="space-y-1 text-muted-foreground">
            <li>✓ El temporizador comienza de inmediato: cuenta atrás de {totalMinutes} minutos</li>
            <li>✓ Todas las respuestas se envían automáticamente cuando se acaba el tiempo</li>
            <li>✓ No actualices la página, no navegues fuera ni abras otra pestaña durante el examen</li>
            <li>✓ Las respuestas se guardan sobre la marcha: las interrupciones de red no harán perder el progreso</li>
            <li>✓ Los exámenes parciales no se puntuarán</li>
          </ul>
        </div>
        ...
        <div className="flex items-center gap-3 pt-2">
          <form action={startFullMock}>
            ...
            >
              Iniciar simulacro completo            </button>
          </form>
          <Link
            href="/exams"
