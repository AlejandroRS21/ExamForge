// OpenSloth — Per-Part Score Breakdown Component
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="bg-muted/50">
            <th className="text-left px-4 py-3 font-medium text-muted-foreground">Parte</th>
            <th className="text-center px-4 py-3 font-medium text-muted-foreground">Preguntas</th>
            <th className="text-center px-4 py-3 font-medium text-muted-foreground">Correctas</th>
            <th className="text-center px-4 py-3 font-medium text-muted-foreground">Puntuación</th>
            <th className="text-right px-4 py-3 font-medium text-muted-foreground">Barra</th>
          </tr>
        </thead>
