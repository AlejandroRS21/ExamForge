...
export default async function ExamsPage() {
  ...
  // E-C-2: count derived from seeded parts (8+8+8+6+6+10+10 = 56)
      ...
      <div className="container mx-auto px-4 py-10 max-w-5xl">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
            <div>
              <h2 className="text-2xl font-extrabold text-amber-950 flex items-center gap-2">
                <TargetIcon className="w-6 h-6" color="var(--primary)" /> Modos de Práctica Individual
              </h2>
                ...
                >
                  <div>
                    <div className="flex items-center justify-between gap-2 mb-2">
                      <span className="font-bold text-base text-amber-950 group-hover:text-primary transition-colors">
                        {part.label}
                      </span>
        ...
        <section className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-extrabold text-amber-950 flex items-center gap-2">
                <PlayIcon className="w-6 h-6" color="var(--primary)" /> Simulacro de Examen Oficial
              </h2>
              <p className="text-sm font-medium text-amber-800/80 mt-0.5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Link
              href="/exams/mock/new"
              className="rounded-3xl border-2 border-orange-300 bg-gradient-to-br from-orange-500 to-primary p-6 text-white shadow-[0_6px_0_0_#C84B1B] hover:brightness-105 active:translate-y-1 active:shadow-none transition-all flex flex-col justify-between"
            >
              <div>
                ...
                <p className="text-sm font-medium text-orange-50 mt-2 leading-relaxed">
                  {totalRuoeQuestions} preguntas oficiales, 1 hora y 15 minutos en tiempo real.
                </p>
              </div>
              <div className="flex items-center justify-between mt-6 pt-4 border-t border-white/20 text-xs font-bold text-white">
                <span>{totalRuoeQuestions} Preguntas Totales</span>
