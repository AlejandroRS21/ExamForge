// OpenSloth — Edit Question Form (Client Component)
...
export function EditQuestionForm({ question }: EditFormProps) {
  ...
  return (
    <div className="rounded-xl border p-6 space-y-4">
      <h2 className="text-lg font-semibold">Editar pregunta</h2>
      ...
      <div className="space-y-1.5">
        <label className="text-sm font-medium">Enunciado (JSON)</label>
        <textarea
          value={prompt}
      ...
      <div className="space-y-1.5">
        <label className="text-sm font-medium">Respuesta correcta (JSON)</label>
        <textarea
          value={correctAnswer}
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="space-y-1.5">
          ...
          >
            ...
            <option value="C">C — Reto</option>
          </select>
        </div>

        <div className="space-y-1.5">
          <label className="text-sm font-medium">Habilidades evaluadas (separadas por comas)</label>
          <input
            type="text"
            value={skillsTested}
