// OpenSloth — 3D Tactile Button (server-safe)
...
const BASE_CLASSES =
  "inline-flex items-center justify-center gap-2 rounded-2xl px-5 py-2.5 text-sm font-bold transition-all active:translate-y-1 active:shadow-none disabled:opacity-40 disabled:pointer-events-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary";

const VARIANT_CLASSES: Record<TactileButtonVariant, string> = {
  primary:
    "bg-primary text-white shadow-[0_4px_0_0_var(--btn-shadow-primary)] hover:brightness-105",
  amber:
    "border-2 border-amber-200 bg-white text-amber-950 shadow-[0_4px_0_0_#FDE68A] hover:bg-amber-50",
  soft: "border-2 border-[#E5D9CC] bg-background text-amber-950 shadow-[0_3px_0_0_#E5D9CC] hover:bg-[#FFE8D6]",
};
